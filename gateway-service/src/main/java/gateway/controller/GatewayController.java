...
import gateway.transformer.URLRequestTransformer;
...
public class GatewayController {
  ...
  @ResponseBody
  public ResponseEntity proxyRequest(HttpServletRequest request) throws NoSuchRequestHandlingMethodException, IOException, URISyntaxException {
    HttpUriRequest proxiedRequest = createHttpUriRequest(request);
    logger.info("service properties: {}", apiGatewayProperties);
