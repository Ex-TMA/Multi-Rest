...
public class Utils {
    ...
    static {
        ...
        try {
            ...
            log.error("IOException in account.Utils", e);
        } catch (IllegalAccessException e) {
            log.error("IllegalAccessException in account.Utils", e);
        } catch (InstantiationException e) {
            log.error("InstantiationException in account.Utils", e);
        } catch (ClassNotFoundException e) {
            log.error("ClassNotFoundException in account.Utils", e);
        }
    }
